...
```{r Adjust formatting for dates, include=TRUE}
...
```{r create product categories, include=TRUE}
...
```{r test for maps, include=TRUE, warning=TRUE}
...
```{r break out specific products, include=TRUE}
p1 = calendarHeat(
  Sales$ContractDate,
  Sales$GrossAmount,
  color = 'r2b',
